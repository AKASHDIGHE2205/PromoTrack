...
import { login, addUser, bulkAddUsers, getUsers, getUserById, updateUser, toggleUserStatus, getMyProfile, updateMyProfile, changeMyPassword } from "../controllers/auth.controller.js";
...
router.post("/bulk-add-users", authenticate, authorize("Admin","Master", "Manager"), bulkAddUsers);
